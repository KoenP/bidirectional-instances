...
-- Make this a separate function in Utils.Ctx?
...
-- It does not return the environment extension, rather the extended environment.
...
rnFail :: MonadError CompileError m => Doc -> m a
rnFail = throwErrorM
