...
destructPolyTy :: PolyTy a -> ([HsTyVarWithKind a], ClsCs a, MonoTy a) -- Type synonym for lists of type variables?
...
-- Careful. This does not check that the kinds are the same for every
